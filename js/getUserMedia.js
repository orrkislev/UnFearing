...
*/;(function (window, document) {
    ...
    window.getUserMedia = function (options, successCallback, errorCallback) {
        ...
        if (options !== undefined) {
            ...
            if( typeof navigator.mediaDevices !== 'undefined' && navigator.mediaDevices.getUserMedia ){ //firefox
                navigator.mediaDevices.getUserMedia(option_object)
                .then(successCallback)
                .catch(errorCallback);
            }
            else{ //mainly chrome and old firefox
